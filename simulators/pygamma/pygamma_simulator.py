...
#                  Frank C Langbein <frank@langbein.org>, Cardiff University, 2020
...
def pygamma_spectra_sim(metabolite_name, omega, pulse_sequence, linewidth, cache_dir,
    ...
    infile = os.path.join('simulators', 'pygamma', 'metabolite_models', metabolite_name.lower() + '.sys')
    ...
    with open(os.path.join(cache_dir, metabolite_name + '.json'), 'wb') as save_file:
...
if __name__ == '__main__':
    ...
    pygamma_spectra_sim(args.metabolite, args.omega, args.pulse_sequence, args.linewidth, args.cache, args.npts, args.adc_dt)
